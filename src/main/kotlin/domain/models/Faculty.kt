...
class Faculty(name: String, userId: String, email: String) : User(name, userId, email) {
    companion object CommonInfo {
        private val MAX_BOOKS: Int = UserType.FACULTY.maxBooks
        private val BORROW_DAYS: Int = UserType.FACULTY.borrowDays
        private val FINE_PER_DAY: Double = UserType.FACULTY.finePerDay
    }
